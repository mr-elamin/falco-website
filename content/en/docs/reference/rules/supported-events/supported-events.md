...
This reference lists all supported Falco events for schema version 4.3.0. It is organized as a quick summary first, followed by exhaustive event tables.

## How to read this page

- **Default**: whether the event is enabled by default.
- **Dir**: event direction (`>` for entry, `<` for exit).
- **Name**: event name.
- **Params**: parameters reported for the event, in the `TYPE **name**` format; when present, enumerated values follow `:`.

## At a glance

| Category | Event names | Event rows |
|:---------|------------:|-----------:|
| Syscall events | 434 | 711 |
| Tracepoint events | 4 | 4 |
| Plugin events | 1 | 1 |
| Metaevents | 12 | 13 |
...
### Syscall section index

| Section | Name range | Event names | Event rows |
|:--------|:-----------|------------:|-----------:|
| [A-E](#syscall-events-ae) | `A-E` | 50 | 73 |
| [F-L](#syscall-events-fl) | `F-L` | 122 | 201 |
| [M-R](#syscall-events-mr) | `M-R` | 123 | 202 |
| [S-Z](#syscall-events-sz) | `S-Z` | 137 | 231 |
| [Other](#syscall-events-other) | `Other` | 2 | 4 |
...
#### Syscall events Other
<a id="syscall-events-other"></a>
